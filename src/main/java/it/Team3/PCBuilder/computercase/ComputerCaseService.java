...
public class ComputerCaseService {
    ...
    public Iterable<ComputerCase> findComputerCaseByMotherboardFormFactor(String motherboardFormFactor) {
        return computerCaseRepository.findComputerCaseByMotherboardFormFactor(motherboardFormFactor);
    }
}
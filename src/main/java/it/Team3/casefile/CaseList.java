...
public class CaseList {
    ...
    Case coolerMaster = new Case("Cooler Master", "MasterBox Q300L", "Micro ATX Mini Tower", "Black",
            ...
            1, 2, 4, "120mm × 2");
<<<<<<< HEAD:src/main/java/it/Team3/Case/CaseList.java
    
    Case phanteksEnthooProM = new Case("Phanteks", "Enthoo Pro M", "ATX Mid Tower", "Black",
            "USB 3.1 Gen 2 Type-C, USB 3.0 × 2", "ATX, Micro ATX, Mini ITX", "406 mm / 16.0",
            2, 2, 7, "360mm × 1 or 280mm × 1");
    
    Case nzxtH710i = new Case("NZXT", "H7i10", "ATX Mid Tower", "White",
=======
...
>>>>>>> b4affb57015c3bcd5fdeaae71912f25a72bdc86d:src/main/java/it/Team3/casefile/CaseList.java
...
<<<<<<< HEAD:src/main/java/it/Team3/Case/CaseList.java
    ...
    Case corsairC680x = new Case("Corsair", "Crystal Series 680X", "ATX Mid Tower", "Black",
=======

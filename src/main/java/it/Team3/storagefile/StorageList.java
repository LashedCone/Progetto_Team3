...
public class StorageList {
    ...
    Storage kingstonA2000 = new Storage("Kingston", "A2000", "SA2000M8/1000G", (short) 1000, "SSD", "M.2-2280", "M.2 PCIe 3.0 X4", true);

    Storage samsung970EvoPlus500Gb = new Storage("Samsung", "970 Evo Plus 500GB", "MZ-V7S500BW", (short) 500, "SSD", "M.2-2280", "M.2 PCIe 3.0 X4", true);

    Storage seagateBarraCuda4Tb = new Storage("Seagate", "BarraCuda 4TB", "ST4000DM004", (short) 4000, "HDD", "3.5", "SATA", false);

    Storage sandiskExtremePro2Tb = new Storage("SanDisk", "Extreme Pro 2TB", "SDSSDXPM2-2T00-G25", (short) 2000, "SSD", "M.2-2280", "M.2 PCIe 3.0 X4", true);

    Storage wdRedPro10Tb = new Storage("Western Digital", "Red Pro 10TB", "WD101KFBX", (short) 10000, "HDD", "3.5", "SATA", false);

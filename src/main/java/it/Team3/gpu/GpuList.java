...
public class GpuList {
    ...
    Gpu pny = new Gpu("PNY", "VCG408016TFXPB1",
            ...
            2205, 2505, 22400,
            "PCIe x16", 332, 320);
    Gpu radeonRX8700XT = new Gpu("AMD", "RX8700XT16GB",
            "Radeon RX 8700 XT", 16, "GDDR6",
            2100, 2500, 19200,
            "PCIe x16", 310, 290);
    
    Gpu asusROGStrixRTX4070 = new Gpu("ASUS", "ROG407016G",
            "GeForce RTX 4070", 16, "GDDR6X",
            2150, 2550, 22000,
            "PCIe x16", 328, 310);
    
    Gpu msiRadeonRX6800 = new Gpu("MSI", "MSIRX680016G",
            "Radeon RX 6800", 16, "GDDR6",
            2100, 2500, 19200,
            "PCIe x16", 312, 300);
    
    Gpu evgaGeForceGTX4080FTW3 = new Gpu("EVGA", "EVGAGTX408016G",
            "GeForce GTX 4080", 16, "GDDR6X",
            2250, 2550, 22500,
            "PCIe x16", 335, 330);
    
    Gpu sapphirePulseRX6700XT = new Gpu("Sapphire", "SAPRX6700XT16G",
